...
Bullet0::Bullet0(glm::vec2 position, glm::vec2 direction, float damage, float speed)
...
bool Bullet0::update(const std::vector<std::string>& levelData, float deltaTime)
{
...
void Bullet0::draw(Bengine::SpriteBatch& spriteBatch)
{
...
bool Bullet0::collideWithAgent(Agent* agent)
{
...
bool Bullet0::collideWithWorld(const std::vector<std::string>& levelData)
{
