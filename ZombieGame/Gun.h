...
public:
	...
	void update(bool isMouseDown, const glm::vec2& position, const glm::vec2& direction, std::vector<Bullet0>& bullets, float deltaTime);

private:

	Bengine::SoundEffect m_fireEffect;

	void fire(const glm::vec2& direction, const glm::vec2& position, std::vector<Bullet0>& bullets);
